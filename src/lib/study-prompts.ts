...
- Average score % = (marks awarded ÷ marks available) across that topic's questions, as a whole-number percentage. If marks are not stated for a question, exclude it from the average and write "[marks not stated]".
